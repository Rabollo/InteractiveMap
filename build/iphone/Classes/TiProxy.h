...
//Rare exceptions to indicate a bug in the _interactivemap_wroclaw code (Eg, function that a subclass should have implemented)
...
/**
 The base class for InterActiveMap_Wroclaw proxies.
 */
