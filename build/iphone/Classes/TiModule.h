...
/**
 The base class for all InterActiveMap_Wroclaw modules
 */
...
/**
 InterActiveMap_Wroclaw Platform calls this method on startup.
 */
-(void)startup;

/**
 InterActiveMap_Wroclaw Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 InterActiveMap_Wroclaw Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 InterActiveMap_Wroclaw Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 InterActiveMap_Wroclaw Platform calls this method on resume.
 @param sender The sender of the event.
 */
