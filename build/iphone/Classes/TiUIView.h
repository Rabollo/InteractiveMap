...
/**
 Base class for all InterActiveMap_Wroclaw views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the InterActiveMap_Wroclaw view hierarchy (such as wrapped iOS UIViews) was touched.
