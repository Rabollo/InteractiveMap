...
// in simulator we redefine to format for InterActiveMap_Wroclaw Developer console
...
{\
	NSString * exceptionName = [@"org.interactivemap_wroclaw." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.interactivemap_wroclaw";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIInterActiveMap_WroclawNativeItemNone = -1, 
	UIInterActiveMap_WroclawNativeItemSpinner = -2,
	UIInterActiveMap_WroclawNativeItemProgressBar = -3,
	
	UIInterActiveMap_WroclawNativeItemSlider = -4,
	UIInterActiveMap_WroclawNativeItemSwitch = -5,
	UIInterActiveMap_WroclawNativeItemMultiButton = -6,
	UIInterActiveMap_WroclawNativeItemSegmented = -7,
	
	UIInterActiveMap_WroclawNativeItemTextView = -8,
	UIInterActiveMap_WroclawNativeItemTextField = -9,
	UIInterActiveMap_WroclawNativeItemSearchBar = -10,
	
	UIInterActiveMap_WroclawNativeItemPicker = -11,
	UIInterActiveMap_WroclawNativeItemDatePicker = -12,
	
	UIInterActiveMap_WroclawNativeItemInfoLight = -13,
	UIInterActiveMap_WroclawNativeItemInfoDark = -14,
	
	UIInterActiveMap_WroclawNativeItemDisclosure = -15,
	
	UIInterActiveMap_WroclawNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all InterActiveMap_Wroclaw instances of
