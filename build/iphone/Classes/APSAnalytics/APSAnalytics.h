 ...
 * to send analytic data that can be viewed on the InterActiveMap_Wroclaw Dashboard.
 *
 * For information on getting started with InterActiveMap_Wroclaw Platform Services,
