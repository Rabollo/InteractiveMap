...
@interface InterActiveMap_WroclawObject : KrollCoverageObject {
#else
@interface InterActiveMap_WroclawObject : KrollObject {
#endif
@private
...
extern NSString * InterActiveMap_Wroclaw$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	InterActiveMap_WroclawObject *_interactivemap_wroclaw;
    KrollObject* console;
	BOOL shutdown;
