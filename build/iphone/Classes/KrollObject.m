...
//@interface InterActiveMap_WroclawObject : NSObject
//@end

@interface InterActiveMap_WroclawObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[InterActiveMap_WroclawObject class]])
		{
			for (NSString *key in [[(InterActiveMap_WroclawObject*)o modules] allKeys])
			{
